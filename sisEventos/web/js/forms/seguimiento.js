...
function anularOrd(){
	...
	jConfirm(mensaje_sistema[158],"confirmacion",function(r){
		if(r==true){
    ...
    function(data){
    	if(data!=null){
    		...
    		for(i=0; i<datos.length; i++){
    			...
    			var metrado = datos[i].metrado_real;
...
function loadDataResDialog(tot){
	var igv = parseFloat(tot)*(parseFloat($("#txtIgv").val())/100);
